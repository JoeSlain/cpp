...
/*   Updated: 2022/02/24 22:11:00 by jcueille         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form( std::string name, int sign_grade, int exec_garde ) : _name(name), _sign_grade(sign_grade), _exec_grade(exec_grade)
{
	if (_exec__grade < 1 || )
